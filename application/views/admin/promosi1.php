        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <?php if (isset($promosi) && is_array($promosi)): ?>
                    <!-- Disable button if there is data -->
                    <?php $is_disabled = !empty($promosi) ? 'disabled' : ''; ?>
                    <a href="<?php echo site_url('promosi/create1'); ?>" class="btn btn-primary mb-3 <?php echo $is_disabled; ?>" <?php echo $is_disabled; ?>>
                        Tambah Promosi
                    </a>
                <?php endif; ?>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo site_url('promosi/edit1/' . $promo['id']); ?>" class="btn btn-sm btn-warning">Edit</a>
                                                <a href="<?php echo site_url('promosi/delete1/' . $promo['id']); ?>" 
