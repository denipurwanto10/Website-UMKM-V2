...
<?php include('sidebar.php'); ?>
    <div class="container mt-3">
        ...
        <div class="card">
            <div class="card-header  d-flex justify-content-between align-items-center">
                <h5 style="color:white;" class="mb-0">List Pengguna</h5>
                        ...
                        <table class="table table-hover" id="usersTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th style="color:white;" class="sortable" data-sort="username">Username</th>
                                    <th style="color:white;" class="sortable" data-sort="fullname">Fullname</th>
                                    <th style="color:white;" class="sortable" data-sort="usertype">Role</th>
                                    <th style="color:white;" class="sortable" data-sort="email">Email</th>
                                    <th  style="color:white;"class="sortable" data-sort="nomor_hp">Nomor HP</th>
                                    ...
                                    <tr>
                                        <td>
                                            <?php if (isset($user['photo']) && !empty($user['photo'])): ?>
                                                <img src="<?php echo base_url('uploads/users/' . $user['photo']); ?>" alt="User Photo" style="width:50px; height:50px; object-fit:cover; border-radius: 50%;">
                                            <?php else: ?>
                                                <img src="<?php echo base_url('uploads/users/default.png'); ?>" alt="Default Photo" style="width:50px; height:50px; object-fit:cover; border-radius: 50%;">
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                            <?php 
                                                $role = htmlspecialchars($user['usertype'] ?? '-');
                                                $roleClass = ($role == 'Admin') ? 'badge-admin' : 'badge-owner';
                                            ?>
                                            <span class="badge <?php echo $roleClass; ?>"><?php echo $role; ?></span>
                                        </td>
                                        <td><?php echo htmlspecialchars($user['email'] ?? '-'); ?></td>
                                        <td><?php echo htmlspecialchars($user['nomor_hp'] ?? '-'); ?></td>
                                        <td>
                                            <div class="action-buttons">
                                                <a href="<?php echo site_url('users/edit/' . $user['username']); ?>" class="btn btn-sm btn-warning">Edit</a>
                                                <a href="<?php echo site_url('users/delete/' . $user['username']); ?>" 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="pagination-info">
                                <span id="showing-entries">Menampilkan 1 sampai <?php echo min(5, count($users)); ?> dari <?php echo count($users); ?> entri</span>
                            </div>
                        </div>
                        <div class="col-md-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // If there's a flash error message, show an error alert
